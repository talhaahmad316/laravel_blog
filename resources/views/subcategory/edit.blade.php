        ...
        @method('PUT')
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" id="CategoryName" placeholder="Category Name" value="{{ old('name', $subcategory->name) }}">
            </div>
            @if($errors->has('name'))
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <div class="custom-file">
                  <input type="file" name="image" class="custom-file-input" id="exampleInputFile" value="{{ old('image', $subcategory->image) }}">
